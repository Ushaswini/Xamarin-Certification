...
using RayHotDog.Droid.Adapters;
using RayHotDog.Droid.Fragments;
...
namespace RayHotDog.Droid
{
    ...
    public class HotDogMenuActivity : Activity
    {
        ...
        protected override void OnCreate(Bundle savedInstanceState)
        {
            ...
            AddTab("Favorites", Resource.Drawable.Gold_Star, new FavoriteHotDogFragment());
            AddTab("Meat Lovers", Resource.Drawable.Meat, new MeatLoversFragment());
            AddTab("Veggie Lovers", Resource.Drawable.Veggies, new VeggieLoversFragment());
        ...
        private void AddTab(string tabText,int iconResourceId,Fragment view)
        {
            ...
            tab.TabSelected += delegate (object sender, ActionBar.TabEventArgs e)
             {
                 //check if there is a fragment inside this fragment container
